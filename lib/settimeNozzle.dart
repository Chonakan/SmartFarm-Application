...
class SettimeNozzle extends StatefulWidget {
  @override
  _SettimeNozzleState createState() => _SettimeNozzleState();
}

class _SettimeNozzleState extends State<SettimeNozzle> {
  ...
  Widget build(BuildContext context) {
    final ref = fb.reference().child('Nozzle-Settime');
    return Column(
      children: [
        Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              "The Nozzle will turn on at the specified time",
                              style: TextStyle(
                                  fontSize: 12, color: Colors.black54),
                            ),
                            SizedBox(
