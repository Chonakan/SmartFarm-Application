...
class SettimePump extends StatefulWidget {
  @override
  _SettimePumpState createState() => _SettimePumpState();
}

class _SettimePumpState extends State<SettimePump> {
  ...
  Widget build(BuildContext context) {
    final ref = fb.reference().child('Pump-Settime');
    return Column(
      children: [
        Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              "The pump will turn on at the specified time",
                              style: TextStyle(
                                  fontSize: 12, color: Colors.black54),
                            ),
                            SizedBox(
